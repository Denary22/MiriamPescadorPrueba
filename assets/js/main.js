...
document.addEventListener("DOMContentLoaded", function () {
  ...
  filterButtons.forEach((button) => {
    button.addEventListener("click", () => {
      ...
      // Agrega clase "active" al botón clicado
...
document.addEventListener("DOMContentLoaded", function () {
  const blogFilterButtons = document.querySelectorAll(".blog-filter-inner button");
  ...
  // Mostrar todos los elementos del blog al cargar
  showAllBlogItems();

  // Agregar evento de filtrado para el blog
